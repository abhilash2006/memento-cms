...
<head runat="server">
    ...
    <title>Koinónia | Syromalabar Laity Fellowship- Sharjah</title>
...
<body class="no_js responsive boxed-layout chrome ">
    <form id="form1" runat="server">
            ...
            <div id="header" class="group">
                <div class="group inner">
                    ...
                    <div id="logo" class="group">
                        <h1>
                            <a class="logo-text" href="index.html" title="Koinónia">Koin<span>ó</span>nia</a>
                        </h1>
                        <p>Syromalabar Laity Fellowship - Sharjah</p>
                    </div>
                    <!-- END LOGO -->
                    ...
                    <div id="nav" class="group">
                        <ul id="menu-main-nav" class="level-1">
                            ...
                            <li>
                                <a href="#"><i class="icon-film"></i>Sliders</a>
                                <ul class="sub-menu">
                            ...
                            <li>
                                <a href="#"><i class="icon-calendar"></i>Blog</a>
                                <ul class="sub-menu">
                            ...
                            <li>
                                <a href="#"><i class="icon-list-alt"></i>Shortcodes</a>
                                <ul class="sub-menu">
        ...
        <!-- START SLIDER --> 
             ...
             <asp:Repeater ID="Repeater1" runat="server" DataMember="DefaultView" DataSourceID="dsrcSlider">
                <HeaderTemplate>
                    ...
                    <div class="showcase-slide">
                        <div class="showcase-content">
                            ...
                            <div class="showcase-content-wrapper">
                                <img src="images/slider-thumbnails/<%# Eval("UploadImage")%>" alt="<%# Eval("Title")%>"/>
                            </div>
                        </div>
                        <div class="showcase-thumbnail">
                            <img src="images/slider-thumbnails/<%# Eval("UploadImage")%>" />
                        </div>
            ...
            <asp:SqlDataSource ID="dsrcSlider" runat="server" ConnectionString="<%$ ConnectionStrings:SYSTEKNIKCMSConnectionString %>" SelectCommand="SelectBannerFrontEndDisplay" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        ...
        <script type="text/javascript">
            ...
            yiw_slider_thumbnails_speed = 100, yiw_slider_thumbnails_timeout = 1000;
	        </script>
        <!-- /SLIDER -->
            ...
            <div class="inner home-row group">
                ...
                <div class="widget-first widget one-third widget-icon-text group">
                    <h2>
                        <img class="icon-img" src="images/icons/smile.png" alt="" />
                        Meet Koinonia</h2>
                    <p>
                        Koinonia identifies the idealised state of fellowship and community that should exist within the Christian Church.

The act of breaking bread in the manner which Christ prescribed during the Passover meal [John 6:48-69, Matthew 26:26-28, 1 Corinthians 10:16, 1 Corinthians 11:24].
                    </p>
                </div>

                <div class="widget one-third widget-icon-text group">
                    <h2><i class="icon-envelope"></i>Contact the team!</h2>
                    <p>They devoted themselves to the apostles’ teaching and to the communion, to the breaking of bread and to prayer...All the believers were together and had everything in common. Selling their possessions and goods, they gave to anyone as he had need…</p>
                </div>
                ...
                <div class="widget-last widget one-third widget-icon-text group">
                    ...
                    <p>By engaging in this united relationship a new level of consciousness and conscience emerges that spurs the group to higher order thinking and action, thus empowering and encouraging its members to exist in a mutually beneficial relationship.</p>
                </div>
            ...
            <div class="inner home-testimonials home-section group">
                <div class="title">
                    <h2>
                        <img src="images/icons/comment.png" alt="icon-adjust" />
                        People <span>love Memènto</span></h2>
            ...
            <div class="group inner footer_row_1 footer_cols_3">
                ...
                <div class="widget-first widget recent-posts">
                    ...
                    <div class="recent-post group">
                        ...
                        <div class="hentry-post group">
                            <p class="post-date"><span class="day">2</span><span class="month">May</span><span class="year">2012</span></p>
                            <h3><a href="article.html" title="Another great article of the blog" class="title">Another great article of the blog</a></h3>
                            <p class="meta">
                                <span class="comments"><a href="article.html#comments" title="Comment on Another great article of the blog">2 comments</a></span><br />
                                <a href="article.html" class="read-more"></a>
                            </p>
                        </div>

                        <div class="hentry-post group">
                            <p class="post-date"><span class="day">30</span><span class="month">April</span><span class="year">2012</span></p>
                            <h3><a href="article.html" title="Fall in Love with M&egrave;mento theme!" class="title">Fall in Love with Mèmento theme!</a></h3>
                            <p class="meta">
                                <span class="comments"><a href="article.html#respond" title="Comment on Fall in Love with M&egrave;mento theme!">No comments</a></span><br />
                                <a href="article.html" class="read-more"></a>
                            </p>
                        </div>
                ...
                <div class="widget widget_nav_menu">
                    ...
                    <div class="menu-footer-menu-container">
                        <ul id="menu-footer-menu" class="menu">
                            ...
                            <li class="columns2"><a href="features.html">Features</a></li>
                            <li class="columns2"><a href="#">Pages</a></li>
                            <li class="columns2"><a href="contact.html">Contact</a></li>
                            <li class="columns2"><a href="testimonials.html">Testimonials</a></li>
                            <li class="columns2"><a href="portfolio.html">Portfolio</a></li>
                ...
                <div class="quick-contact-widget widget two-third last">
                    <div class="widget-last widget quick-contact">
                        <h3>Quick Contact</h3>
                        <div id="contact-form-example" class="contact-form">
        ...
        <div id="copyright" class="group">
            <div class="inner group">
                <div class="left">
                    <p>
                        Copyright <a href="http://koinoniasharjah.com"><strong>Koinónia Sharjah</strong></a> 2013 -
                    	Powered by <a href="http://systeknik.com" title="Systeknik.com"><strong>Systeknik Inspiration Themes</strong></a>
                    </p>
                </div>
                <div class="right">
                    <a href="https://www.facebook.com/KoinoniaSharjah" class="socials facebook" style="font-size: 30px;" title="Facebook">F</a>
                    <a href="http://www.twitter.com/KoinoniaSharjah" class="socials twitter" style="font-size: 30px;" title="Twitter">L</a>
